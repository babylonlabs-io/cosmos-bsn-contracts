...
fn initialization() {
    ...
    assert_eq!(
        config.network,
        btc_light_client::state::BitcoinNetwork::Testnet
    );
...
mod instantiation {
    ...
    fn instantiate_light_client_msg_works() {
        let params = btc_light_client::msg::InstantiateMsg {
            network: btc_light_client::state::BitcoinNetwork::Testnet,
    ...
    fn instantiate_staking_msg_works() {
        ...
        let params = btc_staking::state::config::Params {
            covenant_pks: vec![],
            covenant_quorum: 1,
            btc_network: btc_light_client::state::BitcoinNetwork::Regtest,
