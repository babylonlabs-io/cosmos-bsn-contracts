...
- [#314](https://github.com/babylonlabs-io/cosmos-bsn-contracts/pull/314) chore: bump babylon to v3.0.0-rc.1
...
- refactor: move ics23_commitment to a new package
...
- chore: use query_grpc from cosmwasm_std
...
- \[OP\] chore: remove unused activated_height
